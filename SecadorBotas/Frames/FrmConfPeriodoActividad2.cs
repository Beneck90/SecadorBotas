...
{
    public partial class FrmConfPeriodoActividad2 : Form
    {
        ...
        public FrmConfPeriodoActividad2()
        {
            InitializeComponent();
        }

        private void FrmConfPeriodoActividad2_Load(object sender, EventArgs e)
        {
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM EncendidoSecador2", cn);
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM ApagadoSecador2", cn);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        private void btnGuardarON_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (SecadorBotas.Clases.ConexBD.ValidaPeriodoONSecador2(dia, hora, minuto))
                {
                ...
                {
                    //LLAMADA DEL METODO INSERTAR ENCENDIDO DE SECADOR 2
                    conex.InsertarEncendido2(dia, hora, minuto);
        ...
        private void pictureBoxBorrarON_Click(object sender, EventArgs e)
        {
...

            {
                ...
                string query = "delete from EncendidoSecador2 where id = @Id";
        ...
        private void btnGuardarOFF_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //VALIDA SI EL REGISTRO YA EXISTE
                if (SecadorBotas.Clases.ConexBD.ValidaPeriodoOFFSecador2(dia, hora, minuto))
                {
                ...
                else
                {
                    ...
                    //LLAMADA DEL METODO INSERTAR APAGADO DE SECADOR 2
                    conex.InsertarApagado2(dia, hora, minuto);
        ...
        private void pictureBoxBorrarOFF_Click(object sender, EventArgs e)
        {
...

            {
                ...
                string query = "delete from ApagadoSecador2 where idOff = @Id";
