...
{
    public partial class FrmConfPeriodoActividad4 : Form
    {
        ...
        public FrmConfPeriodoActividad4()
        {
            InitializeComponent();
        }

        private void FrmConfPeriodoActividad4_Load(object sender, EventArgs e)
        {
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM EncendidoSecador4", cn);
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM ApagadoSecador4", cn);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        private void btnGuardarON_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (SecadorBotas.Clases.ConexBD.ValidaPeriodoONSecador4(dia, hora, minuto))
                {
                ...
                {
                    //LLAMADA DEL METODO INSERTAR ENCENDIDO DE SECADOR 4
                    conex.InsertarEncendido4(dia, hora, minuto);
        ...
        private void pictureBoxBorrarON_Click(object sender, EventArgs e)
        {
...

            {
                ...
                string query = "delete from EncendidoSecador4 where id = @Id";
        ...
        private void btnGuardarOFF_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //VALIDA SI EL REGISTRO YA EXISTE
                if (SecadorBotas.Clases.ConexBD.ValidaPeriodoOFFSecador4(dia, hora, minuto))
                {
                ...
                else
                {
                    ...
                    //LLAMADA DEL METODO INSERTAR APAGADO DE SECADOR 4
                    conex.InsertarApagado4(dia, hora, minuto);
        ...
        private void pictureBoxBorrarOFF_Click(object sender, EventArgs e)
        {
...

            {
                ...
                string query = "delete from ApagadoSecador4 where idOff = @Id";
