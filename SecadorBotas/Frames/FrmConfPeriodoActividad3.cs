...
{
    public partial class FrmConfPeriodoActividad3 : Form
    {
        ...
        public FrmConfPeriodoActividad3()
        {
            InitializeComponent();
        }
        ...
        private void btnGuardarON_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (SecadorBotas.Clases.ConexBD.ValidaPeriodoONSecador3(dia, hora, minuto))
                {
                ...
                {
                    //LLAMADA DEL METODO INSERTAR ENCENDIDO DE SECADOR 3
                    conex.InsertarEncendido3(dia, hora, minuto);
        ...
        private void FrmConfPeriodoActividad3_Load(object sender, EventArgs e)
        {
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM EncendidoSecador3", cn);
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM ApagadoSecador3", cn);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        private void pictureBoxBorrarON_Click(object sender, EventArgs e)
        {
...

            {
                ...
                string query = "delete from EncendidoSecador3 where id = @Id";
        ...
        private void btnGuardarOFF_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //VALIDA SI EL REGISTRO YA EXISTE
                if (SecadorBotas.Clases.ConexBD.ValidaPeriodoOFFSecador3(dia, hora, minuto))
                {
                ...
                else
                {
                    ...
                    //LLAMADA DEL METODO INSERTAR APAGADO DE SECADOR 3
                    conex.InsertarApagado3(dia, hora, minuto);
        ...
        private void pictureBoxBorrarOFF_Click(object sender, EventArgs e)
        {
...

            {
                ...
                string query = "delete from ApagadoSecador3 where idOff = @Id";
