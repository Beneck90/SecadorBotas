...
{
    public partial class FrmTarjeta6 : Form
    {
        ...
        {
            Frames.FrmMenuServicioTarj6 formtMenu6 = new Frames.FrmMenuServicioTarj6();
            formtMenu6.Show();
            this.Close();
        }

        private void FrmTarjeta6_Load(object sender, EventArgs e)
        {
            ...
            int milisegundosON = encendidoUV6 * 60000;

            timerOnUV6.Interval = milisegundosON;

            int milisegundosOFF = apagadoUV6 * 60000;

            timerOffUV6.Interval = milisegundosOFF;
            ...
            //Temp Máxima
            int TempMax6 = Properties.Settings.Default.TempMax6;
            lblTempMax6.Text = TempMax6.ToString() + "°C";
        ...
        private void timer6_Tick(object sender, EventArgs e)
        {
            ...
            {
                //Actualiza estados
                lblEstadoVent6.Text = "ON";
                lblEstadoVent6.BackColor = Color.Lime;
                this.lblEstadoVent6.ForeColor = System.Drawing.ColorTranslator.FromHtml("#000000");//Texto color negro
                //Rota ventilador
            ...
            {
                //Actualiza estados
                lblEstadoVent6.Text = "OFF";
                lblEstadoVent6.BackColor = Color.Red;
                this.lblEstadoVent6.ForeColor = System.Drawing.ColorTranslator.FromHtml("#FFFFFF");//Texto color blanco
                //Inmoviliza 
                pictureBox1.Invalidate();
            ...
            {
                //Actualiza estados
                lblEstadoUV6.Text = "ON";
                lblEstadoUV6.BackColor = Color.Lime;
                this.lblEstadoUV6.ForeColor = System.Drawing.ColorTranslator.FromHtml("#000000");//Texto color negro
            ...
            {
                //Actualiza estados
                lblEstadoUV6.Text = "OFF";
                lblEstadoUV6.BackColor = Color.Red;
                this.lblEstadoUV6.ForeColor = System.Drawing.ColorTranslator.FromHtml("#FFFFFF");//Texto color blanco
            ...
            {
                //Actualiza estados
                lblEstadoCalefactor6.Text = "ON";
                lblEstadoCalefactor6.BackColor = Color.Lime;
                this.lblEstadoCalefactor6.ForeColor = System.Drawing.ColorTranslator.FromHtml("#000000");//Texto color negro
            ...
            {
                //Actualiza estados
                lblEstadoCalefactor6.Text = "OFF";
                lblEstadoCalefactor6.BackColor = Color.Red;
                this.lblEstadoCalefactor6.ForeColor = System.Drawing.ColorTranslator.FromHtml("#FFFFFF");//Texto color blanco
        ...
        private void timerTemp_Tick(object sender, EventArgs e)
        {
            ...
            progressBarTemp6.Value = Respuesta3;
            lblTemp6.Text = Respuesta3.ToString() + "°C";
        ...
        private void timerSesion6_Tick(object sender, EventArgs e)
        {
            R.Close();
        ...
        private void pictureBox8_Click(object sender, EventArgs e)
        {
            R.Close();
            R.EnvioInstruccionRelay("reset");
            Frames.FrmLoginEstado6 formtMenu6 = new Frames.FrmLoginEstado6();
            formtMenu6.Show();
            this.Close();
        }
