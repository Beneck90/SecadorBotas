...
{
    public partial class FrmConfPeriodoActividad6 : Form
    {
        ...
        public FrmConfPeriodoActividad6()
        {
            InitializeComponent();
        }

        private void FrmConfPeriodoActividad6_Load(object sender, EventArgs e)
        {
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM EncendidoSecador6", cn);
        ...
        {
            SqlCommand cmd = new SqlCommand("SELECT * FROM ApagadoSecador6", cn);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        private void btnGuardarON_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (SecadorBotas.Clases.ConexBD.ValidaPeriodoONSecador6(dia, hora, minuto))
                {
                ...
                else
                {
                    ...
                    conex.InsertarEncendido6(dia, hora, minuto);
        ...
        private void btnGuardarOFF_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //VALIDA SI EL REGISTRO YA EXISTE
                if (SecadorBotas.Clases.ConexBD.ValidaPeriodoOFFSecador6(dia, hora, minuto))
                {
                ...
                else
                {
                    ...
                    conex.InsertarApagado6(dia, hora, minuto);
        ...
        private void pictureBoxBorrarON_Click(object sender, EventArgs e)
        {
...

            {
                ...
                string query = "delete from EncendidoSecador6 where id = @Id";
        ...
        private void pictureBoxBorrarOFF_Click(object sender, EventArgs e)
        {
...

            {
                ...
                string query = "delete from ApagadoSecador6 where idOff = @Id";
